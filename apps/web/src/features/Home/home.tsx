...
export default function WrisorLandingHero() {
    ...
    <div className="min-h-screen bg-white flex flex-col justify-start items-center relative">
      ...
      <div className="w-full px-6 py-16 relative">
        ...
        <div className="text-center mb-16 relative">
          ...
          Wrisor is the first editor that thinks with you. Point anywhere, ask for anything, and watch your document build itself.
          </p>
        </div>
...
const Navbar = () => {
  return (
    <nav className="w-full mt-2 py-2 bg-white rounded-lg flex justify-center items-center">
      <div className="absolute left-0 top-0 w-full h-full bg-accent/30 rounded-sm blur-2xl"></div>
      <div className="w-full max-w-4xl flex items-center justify-between px-6">
